...
public class kpathqry {
    ...
    public static void main(String[] args) throws IOException {
        try {
            ...
            while (T-- > 0) {
                ...
                for (int i = 1; i < N; i++)
                    addPath(tree, sc.nextInt(), sc.nextInt());
    ...
    private static boolean process(int nodeWithMaxDepth, int[] parent, int[] level, int[] query, int[] visited,
            int marker) {
